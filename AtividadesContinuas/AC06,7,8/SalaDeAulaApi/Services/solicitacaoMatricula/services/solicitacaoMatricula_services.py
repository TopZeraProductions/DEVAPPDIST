...
from Models.solicitacaoMatricula.dataAccess.solicitacoesMatriculas_dao import SolicitacaoMatriculaDAO
...
from Models.aluno.dataAccess.alunos_dao import AlunoDAO
